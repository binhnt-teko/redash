...
Revision ID: ca41fc2e0767
Revises: 
Create Date: 2020-05-06 11:06:07.250953
...
def upgrade():
    ...
    sa.Column('settings', redash.models.types.PseudoJSON(), nullable=False),
    ...
    sa.Column('change', redash.models.types.PseudoJSON(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    ...
    sa.Column('additional_properties', redash.models.types.PseudoJSON(), nullable=True),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['org_id'], ['organizations.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('name', sa.String(length=255), nullable=False),
    sa.Column('type', sa.String(length=255), nullable=False),
    sa.Column('options', redash.models.types.Configuration(), nullable=False),
    sa.Column('created_at', sa.DateTime(timezone=True), nullable=False),
    sa.ForeignKeyConstraint(['org_id'], ['organizations.id'], ),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    sa.PrimaryKeyConstraint('id')
    ...
    sa.Column('is_archived', sa.Boolean(), nullable=False),
    sa.Column('is_draft', sa.Boolean(), nullable=False),
    sa.Column('schedule', redash.models.types.PseudoJSON(), nullable=True),
    sa.Column('schedule_failures', sa.Integer(), nullable=False),
    sa.Column('options', redash.models.types.PseudoJSON(), nullable=False),
